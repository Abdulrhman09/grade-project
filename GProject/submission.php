...
<div class="user">
    ...
    <form class="form">
        <div class="form__group">
            <input type="text" name="#" placeholder="الاسم الاول" class="form__input" value="<?php echo $_SESSION['user']['bfname']?> "/>
        </div> 
        <form class="form">
            <div class="form__group">
        ...
        <label for="formFileMultiple" class="form-label">تقرير لحالة المستفيد (PDF)</label>
          <input type="file" name="#" class="form__input" placeholder="تقرير لحالة المستفيد  (PDF)" id="formFileMultiple" multiple value=" <?php echo $_SESSION['user']['report']?>"/>
        </div>
